...
The server exposes exactly seven typed tools. Use `list_matters` to discover
...
relationships, `add_episode_cards` for evidence-backed writes, and `correct`
when a human explicitly fixes memory.
