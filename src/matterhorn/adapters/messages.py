...
def build_message_prompt(
    ...
    *,
    ...
    system = (
        ...
        "different tasks. Fill next_step whenever the Records state or clearly "
        "imply the next action; fill due whenever a deadline or date is "
        "stated, resolving relative dates (tomorrow, 周三前) against the "
        "Record's sent_at. Ongoing narrative — what happened in this window of "
